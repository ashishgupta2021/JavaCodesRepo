...
import common.AccountNotFoundException;
import common.DuplicateAccountException;
import common.InMemoryAccountDao;
...
public class InMemoryAccountDaoTests {
	...
	public void removeExistedAccount() {
		...
		System.out.println("removeExistedAccount(): " + accountDao.getAccounts());
	}
