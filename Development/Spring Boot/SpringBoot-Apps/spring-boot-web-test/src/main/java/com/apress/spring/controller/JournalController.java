...
public class JournalController {
	...
	static {
		try {
			...
			entries.add(new JournalEntry("Spring Boot Reading", "Read more about Spirg Boot", "02/01/2016"));
			entries.add(new JournalEntry("Spring Boot in the cloud", "Spirg Boot Cloud Foundary", "05/01/2016"));
