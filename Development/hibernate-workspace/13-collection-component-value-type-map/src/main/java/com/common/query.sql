...
Hibernate: create table IMAGE (Item_id bigint not null, height integer not null, title varchar(255), width integer not null, FILENAME varchar(255) not null, primary key (Item_id, FILENAME)) engine=InnoDB
