...
Hibernate: create table CATEGORY_ITEM (CATEGORY_ID bigint not null, USER_ID bigint, addedOn datetime(6), ITEM_ID bigint not null) engine=InnoDB
...
Hibernate: insert into CATEGORY_ITEM (CATEGORY_ID, USER_ID, addedOn, ITEM_ID) values (?, ?, ?, ?)
Hibernate: insert into CATEGORY_ITEM (CATEGORY_ID, USER_ID, addedOn, ITEM_ID) values (?, ?, ?, ?)
Hibernate: insert into CATEGORY_ITEM (CATEGORY_ID, USER_ID, addedOn, ITEM_ID) values (?, ?, ?, ?)
...
+-------------+---------+----------------------------+---------+
| CATEGORY_ID | USER_ID | addedOn                    | ITEM_ID |
+-------------+---------+----------------------------+---------+
|           1 |       5 | 2020-03-08 18:27:09.254000 |       4 |
|           1 |       5 | 2020-03-08 18:27:09.254000 |       3 |
|           2 |       5 | 2020-03-08 18:27:09.254000 |       3 |
+-------------+---------+----------------------------+---------+
